 ...
 */
public interface LinhaTres<E> extends Iterable<E>, Serializable {

    /**
     * Insere um elemento no início da fila
     *
     * @param elemento elemento a inserir
     * @throws pt.ips.pa.fase1.tads.exceptions.LinhaCheiaException Linha já se
     * encontra preenchida
     */
     ...
     *
     * @throws pt.ips.pa.fase1.tads.exceptions.LinhaSemTresException Linha
    ...
    /**
     * Devolve true se um dos lados da linha estiver cheio, false senão
     *
     * @return true se um dos lados da linha estiver cheio, false senão
     */
    public boolean isFull();

    /**
     * Retira todos os elementos da linha
     */
    public void clear();

    /**
     * Devolve a capacidade dos lados
     *
     * @return capacidade dos lados
     */
