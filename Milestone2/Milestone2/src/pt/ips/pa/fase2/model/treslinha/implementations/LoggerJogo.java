...
public class LoggerJogo implements Logger, Observer {
    ...
    private void registarJogada(Jogo jogo, String jogada) {

        if (canRegistarJogadas()) {
            adicionarRegisto("Jogo [" + jogo.getNomeDoJogo() + "] ID[" + jogo.getId() + "]: Jogada efetuada - " + jogada);
        }
    ...
    private void registarInicio(Jogo jogo) {

        if (canRegistarInicioFim()) {
            adicionarRegisto("Jogo [" + jogo.getNomeDoJogo() + "] ID[" + jogo.getId() + "]: Iniciado");
        }

    }

    private void registarFim(Jogo jogo) {

        if (canRegistarInicioFim()) {
            adicionarRegisto("Jogo [" + jogo.getNomeDoJogo() + "] ID[" + jogo.getId() + "]: Terminou");
        }
    ...
    private void registarUndo(Jogo jogo) {

        if (canRegistarUndo()) {
            adicionarRegisto("Jogo [" + jogo.getNomeDoJogo() + "] ID[" + jogo.getId() + "]: Undo efetuado.");
        }
